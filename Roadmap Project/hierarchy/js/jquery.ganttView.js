        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                for (var j = 0; j < data[i].series.length; j++) {
					var rowDiv = jQuery("<div>", { "class": "ganttview-vtrow" });
                    rowDiv.append(jQuery("<div>", { "class": "ganttview-vtheader-series-name" })
						.append(data[i].series[j].name));
					rowDiv.append(jQuery("<div>", { "class": "ganttview-vtheader-series-cost" })
						.append(data[i].series[j].cost));
					seriesDiv.append(rowDiv);
				}				
